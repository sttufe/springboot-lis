...
public interface ReportService {
    ...
    //免疫传染病
    String getInfectiousDiseases(String b_data, String e_data,String SQLCondition,String condition,String quest_data,String observationItems,String function) ;
}
